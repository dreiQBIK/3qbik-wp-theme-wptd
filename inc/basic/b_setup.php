    ...
    function wptd_setup()
{
    ...
    register_nav_menus(array(
        'primary' => esc_html__('Primary', 'wptd'),
    ));
    ...
    add_theme_support('custom-background', apply_filters('wptd_custom_background_args', array(
        'default-color' => 'ffffff',
        'default-image' => '',
    )));
}
endif;
add_action('after_setup_theme', 'wptd_setup');
