...
$blg_team_teaser = new FieldsBuilder('blg_team_teaser', [
    'title' => 'Team-Teaser',
]);

$blg_team_teaser
    ->addGroup('blg_team_teaser', [
        'label' => '',
    ])
        ...
        ->addTab('content', [
            ...
            ->addGroup('headings', [
                ...
                ->addGroup('label', [
                    ...
                    ->addButtonGroup('choices', [
                        'label' => 'Label wählen',
                        'default_value' => '#icon-label-abbaubar'
                    ])
            ...
            ->addTrueFalse('toggle_search_card', [
                'label' => '"Mitarbeiter suchen"-Karte anzeigen?',
                'wrapper' => ['width' => 100],
                'ui' => 1,
            ])
