...
$blg_images_frontend = new FieldsBuilder('blg_images_frontend', [
    'title' => 'Bildauswahl (Frontend)',
]);

$blg_images_frontend
    ->addGroup('blg_images_frontend', [
        'label' => '',
    ])
        ...
        ->addTab('content', [
            ...
            ->addWysiwyg('text', [
                'label' => 'Text',
                'instructions' => 'Dieser Text geht über die halbe Breite',
                'delay' => 0,
                'media_upload' => 0,
            ])
            ->addImage('image', [
