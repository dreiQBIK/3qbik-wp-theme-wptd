...
$blg_intro_box_client = new FieldsBuilder('blg_intro_box_client', [
    'title' => 'Intro-Box (Kunde)',
]);

$blg_intro_box_client
    ->addGroup('blg_intro_box_client', [
        'label' => '',
    ])
